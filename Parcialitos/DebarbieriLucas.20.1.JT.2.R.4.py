...
def amigos(na,nb):
    if suma_divisores(na)==nb and suma_divisores(nb)==na:
        return True
    else:
        return False
def main():
    ...
    while a<0:
        a=int(input("Error, Ingrese un numero positivo: "))
    b=int(input("Ingrese otro numero positivo: "))
    while a<0:
        b=int(input("Error, Ingrese un numero positivo: "))
    if amigos(a,b)==True:
        print("Los numeros ingresados son amigos")
    else:
         print("Los numeros Ingresados no son amigos")
main()
