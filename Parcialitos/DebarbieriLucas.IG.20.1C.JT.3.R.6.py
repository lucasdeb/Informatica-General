...
def main():
    ...
    cargarLista(lista,inf,sup,cant)
    print("Lista creada:",lista)
    prom=promedio(lista)
    print("Promedio obtenido: {:.2f}".format(prom))
    eliminarMayoresAProm(lista,prom)
    print("Lista modificada:",lista)

def cargarLista (lista,inf, sup, cant):
    cont = 0
    while cont!= cant:
...
def eliminarMayoresAProm(lista,prom):
    lista1 = []
    for i in lista:
        lista1.append(i)
